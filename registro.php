...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mb_strlen($nombre) < 2 || mb_strlen($nombre) > 80) $errores[] = 'Escribe un nombre de 2 a 80 caracteres.';
...
<label for="nombre">Nombre completo</label><input id="nombre" name="nombre" maxlength="80" autocomplete="name" value="<?= e($nombre) ?>" required>
